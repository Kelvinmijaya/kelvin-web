...
const ArticleItem: NextComponentType<NextPageContext, {}, ArticleItemProps> = ({
  id,
  title,
  type,
  url,
  ...
  return (
    <tr key={`article-item${id}`}>
      ...
      <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
        <a target="_blank" href={url} className="text-blue-800 dark:text-white">
          {url}
        </a>
      </td>
      <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
        <div className="flex items-center space-x-3.5">
          <Link
            href={`/dashboard/article/update/${id}`}
