      ...
      try {
        ...
        if (response.ok) {
          ...
          const newErrors: Errors = {
            email: '',
            password: '',
            errorMessage: jsonData.message || 'Error fetch data',
          }
        ...
        const newErrors: Errors = {
          email: '',
          password: '',
          errorMessage: 'Network error fetch data',
        }
    ...
    <form onSubmit={handleLoginSubmit}>
      ...
      <div className="mb-5">
        <input
          ...
          className="w-full cursor-pointer rounded-lg border border-primary bg-red-500 p-4 text-white transition hover:bg-opacity-90  disabled:opacity-75 disabled:bg-white disabled:text-black "
        />
      </div>
      ...
      {(errors.email !== '' ||
        errors.password !== '' ||
        errors.errorMessage !== '') && (
        <div className="w-full bg-red-100 p-2 rounded mb-4">
